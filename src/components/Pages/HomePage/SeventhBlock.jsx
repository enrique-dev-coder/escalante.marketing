      ...
      <article className=" py-8 z-0 relative bg-center bg-cover bg-no-repeat bg-[url('/img/bg_seventh_block.png')] ">
        <div className="relative mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 h-full flex flex-col justify-between ">
          ...
          <div className="flex justify-center ">
            <ul className="font-black  w-[90%] lg:w-full mx-auto z-10 text_shadow_little  text-white text-[40px] lg:text-[50px] list-disc">
              <li>Posting</li>
      ...
      <div className="bg-[url('/img/notes.png')] relative h-[400px] z-10 bg-no-repeat bg-cover bg-center">
        <div className="w-full flex justify-center">
          <div className="bg-primary_bg rounded-full w-fit mx-auto  absolute -top-5 z-20">
            <h2 className="leading-none background_clip mx-auto text-center   text-white text-[40px] lg:text-[60px] pt-4 font-black  lg:w-[80%]">
              For as low as <span className=" text-bright_yellow">$2,500*</span>
            </h2>
          </div>
        </div>
        <div className="relative mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 h-full flex flex-col lg:flex-row ">
          <div className="lg:w-[50%] h-full flex  items-center">
            {" "}
            <h2 className="font-black z-10 text_shadow_little  text-white text-[40px]  mt-10 lg:text-[50px]">
