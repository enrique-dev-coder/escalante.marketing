  ...
  return (
    <article className=" pt-8 bg-center bg-cover bg-no-repeat bg-[url('/img/bg_second_block.png')] ">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 h-full flex flex-col justify-between ">
        <h2 className="leading-none text-white text-[40px] lg:text-[60px] pt-4 font-black lg:w-[60%]">
        ...
        <div className="flex justify-between relative">
          <h2 className=" text-center bg-black/40 rounded-lg absolute  top-[50%] left-0  lg:left-[35%] leading-none text-white text-[40px] lg:text-[60px] pt-4 font-black lg:w-[25%] ">
